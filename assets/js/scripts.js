$(document).ready(function(){
	...
	$('.project-item').click(function(e){
		...
		$('#project-viewer-show').attr('src',$(this).find('img').attr('src'));
	...
	$('.project-nav .next-project').click(function(){
		...
		$('#project-viewer-show').attr('src',$newProject.find('img').attr('src'));
		$('#project-viewer .container').fadeOut(250,function(){loadProject($newProject);});
	});
	...
	function loadProject($project){
		...
		$('#project-viewer-content').load(projectLink,function(){
			$('#project-viewer .container').fadeIn(250);
			afterLoadFn();
		});
